...
//////////////////////////////////////////////////////////////////////////
// ATutorialCodeCharacter

ATutorialCodeCharacter::ATutorialCodeCharacter(const FObjectInitializer &ObjectInitializer) : Super(ObjectInitializer)
{
...
void ATutorialCodeCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAction("CollectPickups", IE_Pressed, this, &ATutorialCodeCharacter::CollectBatteries);

	InputComponent->BindAxis("MoveForward", this, &ATutorialCodeCharacter::MoveForward);
	InputComponent->BindAxis("MoveRight", this, &ATutorialCodeCharacter::MoveRight);
	...
	InputComponent->BindTouch(IE_Released, this, &ATutorialCodeCharacter::TouchStopped);
}


void ATutorialCodeCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
...
void ATutorialCodeCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
...
void ATutorialCodeCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
